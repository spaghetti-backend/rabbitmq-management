...
class AsyncHealthAPI(BaseAPI):
    async def alarms(self) -> dict:
        ...
        """
        try:
            return await self._http_client.get(Paths.health.alarms())
    ...
    async def local_alarms(self) -> dict:
        """
        ...
        """
        try:
            return await self._http_client.get(Paths.health.local_alarms())
        except RMQApiError as e:
            if e.status_code == 503 and e.reason:
                return e.reason
            else:
    ...
    async def certificate_expiration(self, within: int, unit: TimeUnit) -> dict:
        """
    ...
    async def port_listener(self, port: int) -> dict:
        """
        ...
        """
        try:
            return await self._http_client.get(Paths.health.port_listener(port))
        except RMQApiError as e:
            if e.status_code == 503 and e.reason:
                return e.reason
            else:
    ...
    async def protocol_listener(self, protocol: ProtocolUnit) -> dict:
        """
        ...
        """
        try:
            return await self._http_client.get(Paths.health.protocol_listener(protocol))
        except RMQApiError as e:
            if e.status_code == 503 and e.reason:
                return e.reason
            else:
    ...
    async def vhosts(self) -> dict:
        """
        Checks if all virtual hosts and running on the target node.
        """
        try:
            return await self._http_client.get(Paths.health.vhosts())
        except RMQApiError as e:
            if e.status_code == 503 and e.reason:
                return e.reason
            else:
    ...
    async def has_critical_mirror_sync(self) -> dict:
        """
        ...
        """
        try:
            return await self._http_client.get(Paths.health.mirror_critical())
        except RMQApiError as e:
            if e.status_code == 503 and e.reason:
                return e.reason
            else:
    ...
    async def node_quorum_critical(self) -> dict:
        """
        ...
        """
        try:
            return await self._http_client.get(Paths.health.quorum_critical())
        except RMQApiError as e:
            if e.status_code == 503 and e.reason:
                return e.reason
            else:

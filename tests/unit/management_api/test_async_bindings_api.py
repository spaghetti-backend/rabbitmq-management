...
async def test_get_exchange_to_queue_bindings(
    ...
    response = await async_management_api.bindings.exchange_to_queue(
...
async def test_create_exchange_to_queue_binding(
    ...
    response = await async_management_api.bindings.bind_exchange_to_queue(
        vhost="/",
        exchange="te",
        queue="nq",
...
async def test_get_exchange_to_queue_binding_details(
    async_management_api: api.AsyncRMQManagementAPI, api_mock: MockRouter
):
    api_mock.get(url__regex="bindings/%2F/e/te/q/tq/~").respond(
    ...
    response = await async_management_api.bindings.exchange_to_queue_binding_details(
...
async def test_unbind_exchange_from_queue(
    async_management_api: api.AsyncRMQManagementAPI, api_mock: MockRouter
):
...
async def test_get_exchange_to_exchange_bindings(
    ...
    response = await async_management_api.bindings.exchange_to_exchange(
...
async def test_create_exchange_to_exchange_binding(
    routing_key: Optional[str],
    arguments: Optional[dict],
    async_management_api: api.AsyncRMQManagementAPI,
    api_mock: MockRouter,
    ...
    response = await async_management_api.bindings.bind_exchange_to_exchange(
        vhost="/",
        source="te",
        destination="ae",
        routing_key=routing_key,
...
async def test_get_exchange_to_exchange_binding_details(
    async_management_api: api.AsyncRMQManagementAPI, api_mock: MockRouter
):
    api_mock.get(url__regex="bindings/%2F/e/te/e/ae/~").respond(
    ...
    response = await async_management_api.bindings.exchange_to_exchange_binding_details(
...
async def test_unbind_exchange_from_exchange(
    async_management_api: api.AsyncRMQManagementAPI, api_mock: MockRouter
):

...
def test_get_all_parameters(management_api: api.RMQManagementAPI, api_mock: MockRouter):
...
def test_get_vhosts_component_parameters(
    ...
    response = management_api.parameters.component_by_vhost(
...
def test_get_component_parameter_detail(
    ...
    response = management_api.parameters.detail(
...
def test_set_component_parameter(
    management_api: api.RMQManagementAPI, api_mock: MockRouter
):
    mock_json = {
        "value": {
...
def test_get_global_parameter_detail(
    ...
    response = management_api.parameters.global_parameter_detail(parameter="test")

    assert response.get("name") == "test"


def test_set_global_parameter(
    management_api: api.RMQManagementAPI, api_mock: MockRouter
):
    mock_json = {
        "name": "test",
...
def test_delete_global_parameter(
    management_api: api.RMQManagementAPI, api_mock: MockRouter
):
